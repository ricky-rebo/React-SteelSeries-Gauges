...
import RGraph, { HALFPI, PI, TWOPI } from './libs/RGraph.rose';
...
gauges = (function () {
    ...
    var strings = LANG.EN,         // Set to your default language. Store all the strings in one object
        ...
        init = function (dashboard) {
            ...
            if ($(window).width() < 480) {
                config.gaugeScaling = config.gaugeMobileScaling; // Change the gauge scaling
                config.showPopupGraphs = config.mobileShowGraphs; // Switch off graphs?
            }
            ...
            $(_imgBackground).attr('src', config.imgPathURL + 'logoSmall.png'); // small logo
            */
            // End of logo images
...
// ===============================================================================================================================
    ...
    /*!
    * changeLang() function moved here from language.js
    */
